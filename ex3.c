...
int main(int argc,char **argv)
{
  ...
  /*
	...
	Each block starts with the corresponding element in the inputindices*bs. And then it adds
	the remaining (bs-1) elements, which are just the succeeding numbers.
